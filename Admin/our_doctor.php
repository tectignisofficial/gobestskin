  ...
  if(isset($_POST['deletepassword'])){
    ...
    while ($row=mysqli_fetch_array($sql)){ 
      $rowPass=$row['password'];
        ...
        if($pass==1){
            $sql=mysqli_query($conn,"DELETE FROM `our_doctor` WHERE id='$id'");
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Our Doctor Details
                                    </h3>
                                    <a class="btn btn-primary" style="float: right;" href="our_doctor_form.php"><i
                                            class="fa fa-plus"></i> 
                                        Add Details
                                    </a>
                                </div>
                        ...
                        $count=1;
                         ...
                         ?>
                                            <tr>
                                                ...
                                                <td><img src="dist/img/<?php echo $row['photo'];?>" width="50" height="50"></td>
                                                <td><?php echo $row['description'];?></td>
                                                <td>
                                                <a class="btn btn-primary btn-rounded btn-icon"
                                                        href="our_doctor_edit.php?id=<?php echo $row['id']; ?>" title="Edit"><i
