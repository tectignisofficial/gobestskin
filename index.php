    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Best Dermatologists & Trichologists In Your City</h2>
          <p>Leading Chain Of Skin And Hair Clinics in Pune</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <ul>
              <li><i class="bi bi-check-circle"></i> 100+ Expert Dermatologists and Trichologists</li>
              <li><i class="bi bi-check-circle"></i> World-class medical treatments with clinical expertise</li>
              <li><i class="bi bi-check-circle"></i> Most trusted clinics with strong ethical values</li>
            </ul>
