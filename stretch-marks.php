                ...
                <div class="container">
                    <div class="breadcrumb">
                        <ul style="display:flex;font-size:12px;    padding-top: 11px;">
                            ...
                            <li> <span title="Laser Hair Removal">&nbsp;&nbsp; Stretch Marks</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <p><strong>Based on their formation and appearance, there are two types of stretch
                                    marks:</strong></p>
                            <ul>
                                <li><strong>Striae Rubrae:</strong>&nbsp;Striae Rubrae are stretch marks in their
                                    initial
                                    stages of formation. They are faintly raised red, vein-like, and linear lesions.
                                    These
                                    fade over several months, or even year, to whitish striae.</li>
                                <li><strong>Striae Albae</strong>: These are white, creased, depressed stretch marks
                                    that
                                    are more or less permanent. Furthermore, based on their appearance, they are
                                    classified
                            ...
                            <ul>
                                <li><strong>Striae Atrophicans:</strong> Stretch marks associated with thin skin are
                                    called
                                    Striae Atrophicans. They can be seen in medical conditions like Cushing’s Syndrome
                                    or
                                    during the extensive use of corticosteroids.</li>
                                <li><strong>Stria Nigra:</strong> Usually associated with darker skin types, these kinds
                                    of
                                    stretch marks are dark grey or black.</li>
                                <li><strong>Striae Caerulea:</strong> These are dark blue-purplish stretch marks common
                                    with
                        ...
                        <div class="row">
                            ...
                            <ul>
                                <li><strong>Growth During puberty – </strong>About <strong>6%-86%</strong> of people are
                                    likely to experience stretch marks during puberty.Adolescents notice light pink or
                                    light
                                    to dark brown striae on their thighs, breasts and back due to growth spurts.</li>
                                <li><strong>Obesity – </strong>Approximately <strong>43%</strong> of people experience
                                    them
                                ...
                                <li><strong>Pregnancy – </strong>Pregnancy is found to be the most common cause as
                                    nearly
                                    <strong>43-88% </strong>pregnant women are found to have stretch marks.The weight
                                    gain
                                ...
                                <li><strong>Hormonal Variations –</strong> Increased cortisone production from the
                                    adrenal
                                    glands promotes protein catabolism, which usually occurs with injuries, stress, or
                                    underlying medical conditions. As a result, the elastin fibres are negatively
                                    impacted,
                                    resulting in the formation of stretch marks.</li>
                                <li><strong>Genetic Propensity –</strong> Though not extensively explored, it is
                                    suspected
                                ...
                                <li><strong>Symptomatic of Underlying Diseases –</strong> Striae atrophicans (thinned
                                    skin)
                                    occurs in people suffering from Cushing Syndrome and Marfan Syndrome.</li>
                                <li><strong>Weight Loss –</strong> Loosening of the distended skin due to major weight
                                    loss
                ...
                <section id="symptoms" class="col-xs-12 col-sm-12 col-md-12 ">
                    <div class="container">
                        <div class="row">
                            ...
                            <p>Stretch marks may appear as raised, reddish, brown or purplish-pink scars, with a
                                tendency to
                ...
                <section id="diagnosis" class="col-xs-12 col-sm-12 col-md-12 ">
                    <div class="container">
                        <div class="row">
                            ...
                            <p>If your stretch marks are extensive and/or itch persistently; we recommend that you
                                consult a
                                specialist. Depending on the severity, a professional dermatologist can decide the
                                course of
                ...
                <section id="treatments" class="col-xs-12 col-sm-12 col-md-12 ">
                    <div class="container">
                        <div class="row">
                            ...
                            <p>Stretch marks can be challenging to treat and require specific procedures to minimize
                                their
                                appearance. The following stretch marks treatment solutions are available:</p>
                            <ul>
                                <li><a href="#">Micro-needling
                ...
                <section id="prevention" class="col-xs-12 col-sm-12 col-md-12 ">
                    <div class="container">
                        <div class="row">
                            ...
                            <p><em>Disclaimer:</em> Pregnant women are strictly advised to check with their doctors
                                before
